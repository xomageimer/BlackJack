...
void DealerHandler::PlayableHandler::PlayOut(std::shared_ptr<Actors::IDealer> dealer,
...
void DealerHandler::PlayableHandler::NewRound(std::shared_ptr<Actors::IDealer>) {
